...
function tBinList.Empty:boolean;
  begin
  Result:=head^.r=z;
  end;

function tBinList.New_Node(const k:itemType; const i:infoType; const bi:boolean; const ll,rr:pnode):pnode;
  var
    a:longint;
    p:pnodearr;
  begin
...
procedure tBinList.PoolSize(size:integer);
// PoolSize;
  begin
...
procedure tBinList.Del_Node(node:pnode);
// del_node
  begin
  if myPoolSize>0 then
    pool.Put(node)
...
constructor tBinList.Create(size:integer);
// Create
  begin
  inherited Create;
  cnt:=0;
...
procedure tBinList.Change(const v:itemType;const info:infoType);
// Change
  var
    x:pnode;
  begin
...
function tBinList.Search(const v:itemType):infoType;
// Search
  var
    x:pnode;
  begin
...
function tBinList.Search_Min(var i:infoType):itemType;
// Search_Min
  var
    x:pnode;
  begin
...
function tBinList.Search_Max(var i:infoType):itemType;
// Search_Max
  var
    x:pnode;
  begin
...
function tBinList.Search_L(const v:itemType; var i:infoType):itemType;
// Search_L
  var
    x,y:pnode;
  begin
...
function tBinList.Search_G(const v:itemType; var i:infoType):itemType;
// Search_G
  var
    x,y:pnode;
  begin
...
function tBinList.Search_LE(const v:itemType; var i:infoType):itemType;
// Search_LE
  var
    x,y:pnode;
  begin
...
function tBinList.Search_GE(const v:itemType; var i:infoType):itemType;
// Search_GE
  var
    x,y:pnode;
  begin
...
procedure tBinList.Insert(const v:itemType;const info:infoType);
// Insert
  var
    nx,x,p,g,gg,c:pnode;
  procedure split;
...
procedure tBinList.Remove(const v:itemType);
// Remove
  var
    cb:boolean;
...
function tBinList.Count: cardinal;
  begin
  Result:=cnt;
  end;
